...
public enum ScenarioErrorCode implements BaseCode {
    ...
    // 4xx
    EMPTY_SCENARIO_TITLE(HttpStatus.BAD_REQUEST, "SCENARIO_400_1", "시나리오 제목은 필수입니다."),
    EMPTY_SCENARIO_DESCRIPTION(HttpStatus.BAD_REQUEST, "SCENARIO_400_2", "시나리오 상세 설명은 필수입니다."),
    INVALID_LEVEL(HttpStatus.BAD_REQUEST, "SCENARIO_400_3", "유효하지 않은 레벨입니다."),
    ...
    // 5xx
    SCENARIO_GENERATION_FAILED(HttpStatus.BAD_GATEWAY, "SCENARIO_502_1", "AI 서버 시나리오 생성에 실패했습니다."),
